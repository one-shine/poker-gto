...
- **L3 フォント** ✅(2026-05-30): Google Fonts(Bricolage Grotesque / Hanken Grotesk / Zen Kaku Gothic New / JetBrains Mono)は**すべて SIL OFL-1.1** で商用可。セルフホスト時も OFL ファイル同梱 + Reserved Font Name 尊重。CDN 読込は IP 露出につき §3 / PRIVACY_POLICY に明記。
