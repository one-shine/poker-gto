...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { term: 'オーバーベット', reading: 'overbet おーばーべっと', definition: 'ポットを超えるサイズのベット。ナッツ優位があり、ポラライズしたレンジで使う。', relatedTerms: ['ポラライズ', 'ナッツ優位'] },
  { term: 'レンジ優位', reading: 'range advantage れんじゆうい', definition: 'そのボードで平均的に強い手をより多く持つ側。Cベット頻度・サイズの根拠になる。例: A♠K♦Q♠ ではプリフロップレイザー(BTN)が AA/KK/QQ/AK を多く持ちレンジ優位。', relatedTerms: ['ナッツ優位', 'Cベット', 'ボードテクスチャ', 'エクイティ分布'] },
  ...
  { term: 'エクイティ分布', reading: 'equity distribution えくいてぃぶんぷ ばけっとちゃーと', definition: 'レンジ全体のエクイティを手の強さ順に並べたグラフ。2レンジを重ねると、レンジ優位/ナッツ優位とサイズ方針が直感できる。', relatedTerms: ['レンジ優位', 'ナッツ優位', 'エクイティ'] },
  ...
  { term: 'SPR', reading: 'すたっくとぅぽっとれしお stack to pot ratio えすぴーあーる', definition: 'Stack-to-Pot Ratio。フロップ時の有効スタック ÷ ポット。低いほど弱めの手でもコミットでき、高いほど強い手を要する。', relatedTerms: ['スタック深度', 'エクイティ実現'] },
